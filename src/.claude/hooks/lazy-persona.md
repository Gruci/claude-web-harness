...
> 담는 것: lazy 모드 페르소나의 사다리와 규칙, 게으르면 안 되는 경계. 담지 않는 것: 남긴 `lazy:` 마커의 수확(→ `.claude/skills/lazy-debt/SKILL.md`)·과설계 리뷰 절차(→ `.claude/skills/lazy-review/SKILL.md`). 읽는 시점: SessionStart 훅이 매 세션 자동 주입.
