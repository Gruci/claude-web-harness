...
# lazy-review — diff 과설계 리뷰

> 담는 것: diff에서 잘라낼 것만 찾는 리뷰 태그와 한 줄 출력 형식. 담지 않는 것: 레포 전역 감사(→ `.claude/skills/lazy-audit/SKILL.md`)·정확성/보안/성능 리뷰. 읽는 시점: 변경분을 과설계 관점으로 리뷰해달라는 요청 시.
