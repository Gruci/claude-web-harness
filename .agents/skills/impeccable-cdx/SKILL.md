...
3. Project rules override vendor defaults. Colors come from the TypeScript constants, data access goes through the shared hook, and both are enforced by `kernel/runner.py`.
